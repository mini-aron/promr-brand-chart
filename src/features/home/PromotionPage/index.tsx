...
import { BarChart3, Building2, CheckCircle2, FileText, Upload, Users } from 'lucide-react';
      ...
      <section className={s.hero}>
        ...
        <div className={s.features}>
          <div className={s.featureCard}>
            ...
            <h3>실적 대시보드</h3>
            <p>
              법인들이 제출한 실적을 한눈에 조회하고, 월별·법인별 매출 추이를 파악할 수 있습니다.
            </p>
          </div>
          <div className={s.featureCard}>
        ...
        <div className={s.benefitsSection}>
          ...
          <ul className={s.benefitsList}>
            <li className={s.benefitsItem}>
              <CheckCircle2 aria-hidden /> 법인 실적을 정산·검수하는 담당자
            </li>
            <li className={s.benefitsItem}>
              <CheckCircle2 aria-hidden /> 법인별 정산액 산정 및 필터링 승인 업무 담당자
            </li>
            <li className={s.benefitsItem}>
              <CheckCircle2 aria-hidden /> 거래처·병의원 마스터 데이터를 관리하는 담당자
            </li>
            <li className={s.benefitsItem}>
              <CheckCircle2 aria-hidden /> 법인 계약 및 딜러 정보를 확인해야 하는 담당자
            </li>
          </ul>
        </div>
