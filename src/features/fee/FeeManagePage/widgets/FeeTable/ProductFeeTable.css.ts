...
globalStyle(`${feeInputCell} .fee-suffix`, {
  marginLeft: 4,
  fontSize: 13,
  color: 'var(--color-text-muted)',
});
...
globalStyle(
  `${eventTableWrap} th:nth-of-type(3), ${eventTableWrap} td:nth-of-type(3), ${eventTableWrap} th:nth-of-type(6), ${eventTableWrap} td:nth-of-type(6), ${eventTableWrap} th:nth-of-type(7), ${eventTableWrap} td:nth-of-type(7), ${eventTableWrap} th:nth-of-type(8), ${eventTableWrap} td:nth-of-type(8), ${eventTableWrap} th:nth-of-type(9), ${eventTableWrap} td:nth-of-type(9)`,
  {
    textAlign: 'center',
  },
);
...
export const eventRowInapplicable = style({ opacity: 0.5 });
...
globalStyle(`${finalFeeResultRow} .final-fee-rate`, {
  fontWeight: 600,
  fontVariantNumeric: 'tabular-nums',
  fontSize: 14,
});
...
export const metaCell = style([cellBorder, { fontSize: 12, color: 'var(--color-text-muted)' }]);
...
export const filterRowInner = style({
  display: 'flex',
  alignItems: 'center',
  gap: 4,
  flexWrap: 'wrap',
